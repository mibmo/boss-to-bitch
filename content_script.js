...
const data = {
    'de': {
        'singular': {
            ...
            'replacement': casing('Hündin'),
        },
        'plural': {
            'terms': [
                re('heldinnen'),
            ],
            'replacement': casing('Hündinnen'),
        },
    },
    'fr': {
        'singular': {
            ...
            'replacement': casing('Garce'),
        },
        'plural': {
            'terms': [
                re('guerrières'),
            ],
            'replacement': casing('Garces'),
        },
    },
    'en': {
        'singular': {
